...
class Score:
    '''
    爆弾を撃ち落とした数のスコアに関するクラス
    '''
    def __init__(self):
        self.fonto = pg.font.SysFont("hgsoeikakupoptai", 30)
...
class Beam:
    ...
    def __init__(self, bird:"Bird"):
        ...
        self.rct = self.img.get_rect()  # ビームSurfaceのRect抽出
        self.rct.centery = bird.rct.centery  # 中心座標をビームの縦座標
